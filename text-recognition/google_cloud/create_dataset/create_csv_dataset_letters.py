...
for l in letters:
    ...
    test_count, train_count, validate_count = 0,0,0
    for f in train:
        name = f.split('.')[0]
        ...
        for child in root:
            if child.tag == 'object':
                ...
                if str(name) == letter:
                    ...
                    if check:
                        output += 'TEST,gs://' + folder + filename + ',' + letter + ',' + str(xmin) + ',' + str(ymin) \
                                  + ',,,' + str(xmax) + ',' + str(ymax) + ',,\n'
                        main_output += 'TEST,gs://research-pill/dataset_letters/images/' + filename + ',' + letter + ',' + str(
                            xmin) + ',' + str(ymin) \
                                       + ',,,' + str(xmax) + ',' + str(ymax) + ',,\n'
                        test_count += 1
                    else:
                        output += 'TRAIN,gs://' + folder + filename + ',' + letter + ',' + str(xmin) + ',' + str(ymin) \
                                + ',,,' + str(xmax) + ',' + str(ymax) + ',,\n'
                        main_output += 'TRAIN,gs://research-pill/dataset_letters/images/' + filename + ',' + letter + ',' + str(xmin) + ',' + str(ymin) \
                                  + ',,,' + str(xmax) + ',' + str(ymax) + ',,\n'
                        check = True
                        train_count += 1
            ...
            if child.tag == 'object':
                ...
                if str(name) == letter:
                    ...
                    if check:
                        ...
                        output += 'VALIDATE,gs://' + folder + filename + ',' + letter + ',' + str(xmin) + ',' + str(ymin) \
                                + ',,,' + str(xmax) + ',' + str(ymax) + ',,\n'
                        main_output += 'VALIDATE,gs://research-pill/dataset_letters/images/' + filename + ',' + letter + ',' + str(xmin) + ',' + str(ymin) \
                                  + ',,,' + str(xmax) + ',' + str(ymax) + ',,\n'
                        check = True
                        validate_count += 1
        ...
        for child in root:
            if child.tag == 'object':
                ...
                if str(name) == letter:
                    ...
                    output += 'TEST,gs://' + folder + filename + ',' + letter + ',' + str(xmin) + ',' + str(ymin) \
                            + ',,,' + str(xmax) + ',' + str(ymax) + ',,\n'
                    main_output += 'TEST,gs://research-pill/dataset_letters/images/' + filename + ',' + letter + ',' + str(xmin) + ',' + str(ymin) \
                              + ',,,' + str(xmax) + ',' + str(ymax) + ',,\n'
                    test_count += 1

    file = open(csv_file, 'w')
    file.write(output)
    print(letter, train_count,validate_count,test_count)
